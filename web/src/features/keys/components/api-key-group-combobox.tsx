...
export function ApiKeyGroupCombobox({
  ...
  const showAutoEffect = isAutoSelected && !compact
      ...
      <PopoverTrigger
        render={
          <Button
            ...
            data-auto-group-effect={showAutoEffect ? 'trigger' : undefined}
            disabled={disabled}
            className={cn(
              'border-input bg-muted/40 hover:bg-muted/55 hover:text-foreground active:bg-background data-popup-open:border-ring data-popup-open:bg-background data-popup-open:ring-ring/20 relative justify-between gap-2 text-start shadow-none transition-[background-color,border-color,box-shadow] duration-150 data-popup-open:ring-[3px]',
              compact
